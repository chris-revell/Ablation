...
save(plotsdir(inputDir, "Figure5edgeLaplacianHarmonicFieldCellRemoved_$(inputSystem).png"), fig)
save(plotsdir(inputDir, "Figure5edgeLaplacianHarmonicFieldCellRemoved_$(inputSystem).pdf"), fig)
