...
Label(gl0[2,2], "Cells", fontsize=36) #, rotation=π/2)
Label(gl0[2,3], "", fontsize=36) #, rotation=π/2)
Label(gl0[2,4], "Vertices", fontsize=36) #, rotation=π/2)
Label(gl0[2,5], "", fontsize=36) #, rotation=π/2)
Label(gl0[2,6], "Cells", fontsize=36) #, rotation=π/2)
Label(gl0[2,7], "", fontsize=36) #, rotation=π/2)
Label(gl0[2,8], "Vertices", fontsize=36) #, rotation=π/2)
Label(gl0[2,9], "", fontsize=36) #, rotation=π/2)
...
hidespines!.(axes)
display(fig)
save(plotsdir(inputDir, "Figure6Derivatives.png"), fig)
save(plotsdir(inputDir, "Figure6Derivatives.pdf"), fig)