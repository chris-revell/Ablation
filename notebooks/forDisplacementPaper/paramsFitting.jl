...
CSV.write(datadir("displacementFields", dateString, "fittingParamsAblation.csv"), df)
println("Saved at $(datadir("displacementFields", dateString, "fittingParamsAblation.csv"))")
println("Done")