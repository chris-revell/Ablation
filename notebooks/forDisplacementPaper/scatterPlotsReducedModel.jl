...
df = DataFrame(CSV.File(datadir("displacementFields", dateString, "fittingParamsAblationReduced.csv")))
...
save(datadir("displacementFields", dateString, "fittingScatterPlots$(dateStringOut)Reduced.pdf"), fig)
