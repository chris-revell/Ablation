...
push!(axes, Axis(fig[5,1], aspect=DataAspect()))
for i=1:size(B2,1)
...
Colorbar(fig[5,2], colormap=:bam, colorrange=clims, height=Relative(0.8))

push!(axes, Axis(fig[5,3], aspect=AxisAspect(1.0)))
